...
const Multiple = (props) => {
  const multipleMessageFormHandling = (event) => {
      ...
      <main className={classes.main}>
        ...
        <div className={classes.layout}>
          <Card className={classes.formcontrol}>
            <form onSubmit={multipleMessageFormHandling}>
              <div>
                <div className={classes.choosen}>
                  <span className={classes.choosentitle}>Choose Type:</span>
                  <label className={classes.radiobtnlabel}>
                    <input
                      type="radio"
                  ...
                  <label className={classes.radiobtnlabel}>
                    <input
                      ...
                      value="4"
                    />
                    Image With Quick Reply
                  </label>
                </div>
                <div className={classes.scheduledateselect}>
                  <label className={classes.schedulelabelforcheck}>
                    <input
                      type="checkbox"
                      className={classes.scheduledatecheck}
                    />
                    Schedule Date
                  </label>
                  <label className={classes.schedulelabel}>
                    Select Date:
                    <input type="date" className={classes.selectdate} />
                  </label>
                  <label className={classes.schedulelabel}>
                    Select Time:
                    <input type="time" className={classes.selecttime} />
                  </label>
                </div>
              </div>
